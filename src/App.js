...
class App extends Component {
  state = {searchInput: '', displayList: initialTracksList}
  ...
  onDeleteSong = name => {
    ...
    const updatedList = displayList.filter(eachItem => eachItem.name !== name)
    this.setState({displayList: updatedList})
  }
  ...
  renderNoResultsFound = () => <p className="heading">No Songs Found</p>
      ...
      <div className="app-container">
        ...
        <div className="search-container">
          ...
          {searchResults.length === 0
            ...
            : this.renderDisplayResults(searchResults)}
        </div>
      </div>
    )
  }
